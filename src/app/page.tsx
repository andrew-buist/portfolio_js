      ...
      <div className="w-full h-full">
        <DraggableWrapper id="box1">
          <div className="bg-greylight inline-block max-w-2/10 aspect-square">
            ...
            <div className="px-6 py-2 border-palette-b1">
              <Image src="https://images.wallpapersden.com/image/download/capybara-muzzle-nose_aWtmbZSZmpqtpaSklGZsbGetZmZtZg.jpg" alt=""/>
            </div>
          </div>
        </DraggableWrapper>
        <DraggableWrapper id="box2">
          <div className="bg-greylight inline-block max-w-2/10 aspect-square">
            ...
            <div className="px-6 py-2 border-palette-b1">
              <Image src="https://cdn.zmescience.com/wp-content/uploads/2017/06/Capybara_portrait.jpg" alt=""/>
            </div>
          </div>
        </DraggableWrapper>
      </div>
